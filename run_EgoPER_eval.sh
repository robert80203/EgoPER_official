...
python metric_vis.py --task pinwheels --dirname pinwheels_aod_cspl_p2_neg2_bgr1.0_final/ -ed --threshold 0.0
python metric_vis.py --task pinwheels --dirname pinwheels_aod_cspl_p2_neg2_bgr1.0_final/ -od
...
python metric_vis.py --task quesadilla --dirname quesadilla_aod_cspl_p2_neg2_bgr1.0_final/ -ed --threshold 0.0
python metric_vis.py --task quesadilla --dirname quesadilla_aod_cspl_p2_neg2_bgr1.0_final/ -od
...
python metric_vis.py --task tea --dirname tea_aod_cspl_p2_neg2_bgr1.0_final/ -ed --threshold 0.0
python metric_vis.py --task tea --dirname tea_aod_cspl_p2_neg2_bgr1.0_final/ -od
...
python metric_vis.py --task oatmeal --dirname oatmeal_aod_cspl_p2_neg2_bgr1.0_final/ -ed --threshold 0.0
python metric_vis.py --task oatmeal --dirname oatmeal_aod_cspl_p2_neg2_bgr1.0_final/ -od
...
python metric_vis.py --task coffee --dirname coffee_aod_cspl_p2_neg2_bgr1.0_final/ -ed --threshold 0.0
python metric_vis.py --task coffee --dirname coffee_aod_cspl_p2_neg2_bgr1.0_final/ -od