...
xl = pd.ExcelFile('/mnt/raptor/datasets/PTG_dataset/recording/batch2/Data Annotation.xlsx')
labels = {}
...
nframes = {}
for sheet_name in xl.sheet_names[1:]:    
    ffolder = f'/mnt/raptor/datasets/PTG_dataset/recording/batch2/frames_fps{FPS}/{sheet_name}/'
...
for vname, label in labels.items():
    ...
    with open(f"../../dataset/PTG_coffee/label_v1/groundTruth/{vname}.txt", "w") as fp:
