...
xl = pd.ExcelFile('/mnt/raptor/datasets/PTG_dataset/recording/batch7/Data_Annotation.xlsx')
labels = {}
...
nframes = {}
for sheet_name in xl.sheet_names[1:]:    
    ffolder = f'/mnt/raptor/datasets/PTG_dataset/recording/batch7/frames_fps{FPS}/{sheet_name}/'
...
for vname, label in labels.items():
    ...
    with open(f"/mnt/raptor/datasets/PTG_dataset/recording/batch7/processed/label_v1/groundTruth_fps10/{vname}.txt", "w") as fp:
