...
def arg_parser(parser):
    ...
    parser.add_argument('--data_list_name', default='val.txt', type=str,
                        help='data list name')
    parser.add_argument('--groups_per_batch', default=1, type=int, help='number of groups per batch')

    # cpp conversion
    parser.add_argument('--cpp_savefname', default="", type=str, help='filename to save the torch script model')
