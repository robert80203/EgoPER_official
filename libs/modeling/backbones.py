...
#             if idx > 1:
#                 self.gcn.append(GCNBlock(graph_n_embd, num_node, downsample=True, scale_factor=1/(2.0**(idx-1))))
#             else:
#                 self.gcn.append(GCNBlock(graph_n_embd, num_node))
#             self.merge_conv.append(nn.Conv1d(graph_n_embd+n_embd, n_embd, 1, 1, 0, bias=False))
...
#     def forward(self, of, bbox, bbox_class, edge_map, x, mask):
...
#         # gcn 
#         x_gcn = self.gcn[0](bbox, bbox_class, edge_map)
#         x = torch.cat((x, x_gcn), dim=1)
#         x = self.merge_conv[0](x)
...
#             # gcn 
#             x_gcn = self.gcn[idx+1](bbox, bbox_class, edge_map)
#             x = torch.cat((x, x_gcn), dim=1)
#             x = self.merge_conv[idx+1](x)
